 ...
 * using a inner static helper class. The Bill Pugh Singleton implementation goes like this;
 *
 * Notice the private inner static class that contains the instance of the singleton class. When the
 * singleton class is loaded, SingletonHelper class is not loaded into memory and only when someone
...
public class BillPughSingleton {
    ...
    private static class InstanceCreator {
        private static final BillPughSingleton mInstance = new BillPughSingleton();
    }
